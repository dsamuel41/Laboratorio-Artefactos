...
const int TOUCH_PIN_1 = 13;
const int TOUCH_PIN_2 = 12;

const int UMBRAL_TOUCH = 624;
...
void loop() {
  ...
  if (valorTouch1 < UMBRAL_TOUCH) {
    ...
    display.println("SE ESTA TOCANDO 1");
    ...
    display.setCursor(15,28);
    display.println("SE ESTA TOCANDO 2");
    ...
    display.println("NO SE ESTA TOCANDO");
